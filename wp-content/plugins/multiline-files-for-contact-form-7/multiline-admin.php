...
function mfcf7_zl_admin_premium_ver_notice(){
  if( !get_transient('mfcf7-zl-admin-do-not-show-pro-tip')){
      ?>
        ...
        ?>
			<p class="mfcf7-premium-notice-btn"><a href="https://codecanyon.net/item/multiline-files-upload-for-contact-form-7/20632083" target="_blank"><?php _e('Get Pro version', 'zl-mfcf7');?></a>&nbsp;<a href="<?php echo $query_string; ?>mfcf7_zl_pro_ver_notice_ignor_per=0"><?php _e('No Thanks', 'zl-mfcf7');?></a></p>
      </div>
      <?php
    }
}
...
if(!get_transient('mfcf7-zl-admin-do-not-show-rating-tip')){
  ...
  <div class="notice notice-info 1">
    ...
    <p><?php _e('We love and care about you. Our team is putting our maximum efforts to provide you the best functionalities.<br> We would really appreciate if you could spend a couple of seconds to give a Nice Review to the plugin for motivating us!','zl-mfcf7');?></p>
      ...
      ?>
			<span class="mfcf7-premium-notice-btn"><a href="<?php echo $query_string; ?>mfcf7_zl_notice_ignor_temp=7"><?php _e('Maybe Later','zl-mfcf7');?></a></span>
			 <span class="mfcf7-premium-notice-btn"><a href="<?php echo $query_string; ?>mfcf7_zl_notice_ignor_per=0"><?php _e('Already Rated','zl-mfcf7');?></a></span>
		</p>
	</div>
<?php
	}
...
function mfcf7_plugin_meta_links( $links ) {
...
if( !class_exists('ZipArchive') ) {
  ...
  function mfcf7_zl_ziparchive_notice(){
    ...
    echo '<div class="notice notice-warning">
      <p>'. _e('It seems ZIPArchived extension is not installed or not enabled. We need ZIPArchive extension available for multline file upload plugin to work.','zl-mfcf7').' <a href="https://documentation.cpanel.net/display/EA/PHP+Module%3A+Zip" target="_blank">'._e('How to install/enable ZIPArchive?','zl-mfcf7').'</a></p>
    </div>';
